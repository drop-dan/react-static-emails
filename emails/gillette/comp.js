...
const JetHer = () => (
  <DefaultTemplate
    ...
    hero="gillette/gillette_emailbanner_blade_blue.gif"
    title="No commitments, no contracts."
    body="Just your closest shave ever, for less than $3 per month per blade. That's less than the other guys. "
